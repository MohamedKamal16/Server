            ...
            try {
                ...
                try {
                    DriverManager.registerDriver( new org.apache.derby.jdbc.ClientDriver());
                     con = DriverManager.getConnection("jdbc:derby://localhost:1527/DataBase","Mohamed16","161996");}
                        ...
                        case setData:
                           try {
                              ...
                              if (rs.next()){
                                  ...
                                  //add Tie
                                   pst = con.prepareStatement("UPDATE Player SET GAMESPLAYED=?,WIN=?,LOSE=?,Tie=? WHERE NAME =? ");
